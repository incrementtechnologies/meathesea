            ...
            <div class="card nav_card">
              ...
              <div class="card-body initialHeight p-0">
                ...
                >
                  ...
                  >
                    <div v-if="!HeaderElements[typeIndex].changeDate">{{el.order_number}}</div>
                    <div>
                      {{
                        returnDate(el)
                      }}
                ...
                <!-- <b-popover 
                  ref="popover" 
                  class="popover" 
                  v-for="(el, ndx) in data[focusIndex]" :key="'pop' + ndx" 
                  :target="String(ndx) + navs[focusIndex]" 
                  placement="right"
                >
                  <card1 :data="el"/>
                </b-popover> -->
...
export default {
  ...
  computed: {
    returnHeaderElements() {
      if(this.widerView) {
        return this.HeaderElements.filter(el => {
          return el.wholeView
        })
      }else{
