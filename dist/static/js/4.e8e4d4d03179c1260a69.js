 ...
 */
function r(e){function t(e){delete v[e]}function r(e){if(e=e||g,!n.i(u.c)(v,e))throw h.create("no-app",{appName:e});return v[e]}function i(t,r){if(void 0===r&&(r={}),"object"!=typeof r||null===r){r={name:r}}var i=r;void 0===i.name&&(i.name=g);var o=i.name;if("string"!=typeof o||!o)throw h.create("bad-app-name",{appName:String(o)});if(n.i(u.c)(v,o))throw h.create("duplicate-app",{appName:o});var a=new e(t,i,_);return v[o]=a,a}function o(){return Object.keys(v).map(function(e){return v[e]})}function a(t){var i,o,a=t.name;if(y.has(a))return m.debug("There were multiple attempts to register component "+a+"."),"PUBLIC"===t.type?_[a]:null;if(y.set(a,t),"PUBLIC"===t.type){var s=function(e){if(void 0===e&&(e=r()),"function"!=typeof e[a])throw h.create("invalid-app-argument",{appName:a});return e[a]()};void 0!==t.serviceProps&&n.i(u.d)(s,t.serviceProps),_[a]=s,e.prototype[a]=function(){for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n];return this._getService.bind(this,a).apply(this,t.multipleInstances?e:[])}}try{for(var f=n.i(c.a)(Object.keys(v)),l=f.next();!l.done;l=f.next()){var p=l.value;v[p]._addComponent(t)}}catch(e){i={error:e}}finally{try{l&&!l.done&&(o=f.return)&&o.call(f)}finally{if(i)throw i.error}}return"PUBLIC"===t.type?_[a]:null}function s(e,t,n){var r,i=null!==(r=b[e])&&void 0!==r?r:e;n&&(i+="-"+n);var o=i.match(/\s|\//),s=t.match(/\s|\//);if(o||s){var c=['Unable to register library "'+i+'" with version "'+t+'":'];return o&&c.push('library name "'+i+'" contains illegal characters (whitespace or "/")'),o&&s&&c.push("and"),s&&c.push('version name "'+t+'" contains illegal characters (whitespace or "/")'),void m.warn(c.join(" "))}a(new f.b(i+"-version",function(){return{library:i,version:t}},"VERSION"))}function p(e,t){if(null!==e&&"function"!=typeof e)throw h.create("invalid-log-argument",{appName:name});n.i(l.c)(e,t)}function d(e,t){return"serverAuth"===t?null:t}var v={},y=new Map,_={__esModule:!0,initializeApp:i,app:r,registerVersion:s,setLogLevel:l.b,onLog:p,apps:null,SDK_VERSION:w,INTERNAL:{registerComponent:a,removeApp:t,components:y,useAsService:d}};return _.default=_,Object.defineProperty(_,"apps",{get:o}),r.App=e,_}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
function(e,t){e.INTERNAL.registerComponent(new f.b("platform-logger",function(e){return new k(e)},"PRIVATE")),e.registerVersion(d,v,t),e.registerVersion("fire-js","")}(A),t.a=A},496:function(e,t,n){"use strict";(function(e){/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
function p(e,t){var r=t.fid;return n.i(ae.e)(this,void 0,void 0,function(){var t,c,f,l,p,h,d;return n.i(ae.f)(this,function(n){switch(n.label){case 0:return t=i(e),c=s(e),f={fid:r,authVersion:he,appId:e.appId,sdkVersion:pe},l={method:"POST",headers:c,body:JSON.stringify(f)},[4,u(function(){return fetch(t,l)})];case 1:return p=n.sent(),p.ok?[4,p.json()]:[3,3];case 2:return h=n.sent(),d={fid:h.fid||r,registrationStatus:2,refreshToken:h.refreshToken,authToken:o(h.authToken)},[2,d];case 3:return[4,a("Create Installation",p)];case 4:throw n.sent()}})})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
function h(e){return new Promise(function(t){setTimeout(t,e)})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
function d(e){return btoa(String.fromCharCode.apply(String,n.i(ae.g)(e))).replace(/\+/g,"-").replace(/\//g,"_")}function v(){try{var e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;var t=g(e);return me.test(t)?t:ye}catch(e){return ye}}function g(e){return d(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
function B(e,t){var r=e.appConfig,i=e.platformLoggerProvider;return n.i(ae.e)(this,void 0,void 0,function(){var e,s,f,l,p,h,d,v;return n.i(ae.f)(this,function(n){switch(n.label){case 0:return e=L(r,t),s=c(r,t),f=i.getImmediate({optional:!0}),f&&s.append("x-firebase-client",f.getPlatformInfoString()),l={installation:{sdkVersion:pe}},p={method:"POST",headers:s,body:JSON.stringify(l)},[4,u(function(){return fetch(e,p)})];case 1:return h=n.sent(),h.ok?[4,h.json()]:[3,3];case 2:return d=n.sent(),v=o(d),[2,v];case 3:return[4,a("Generate Auth Token",h)];case 4:throw n.sent()}})})}function L(e,t){var n=t.fid;return i(e)+"/"+n+"/authTokens:generate"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
function te(e){var t,r;if(!e||!e.options)throw ne("App Configuration");if(!e.name)throw ne("App Name");var i=["projectId","apiKey","appId"];try{for(var o=n.i(ae.a)(i),a=o.next();!a.done;a=o.next()){var s=a.value;if(!e.options[s])throw ne(s)}}catch(e){t={error:e}}finally{try{a&&!a.done&&(r=o.return)&&r.call(o)}finally{if(t)throw t.error}}return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}function ne(e){return be.create("missing-app-config-values",{valueName:e})}var re,ie=n(495),oe=n(497),ae=n(493),se=n(496),ce=n(539),ue=(n.n(ce),"@firebase/installations"),fe="0.4.19",le=1e4,pe="w:"+fe,he="FIS_v2",de="https://firebaseinstallations.googleapis.com/v1",ve=36e5,ge=(re={},re["missing-app-config-values"]='Missing App configuration value: "{$valueName}"',re["not-registered"]="Firebase Installation is not registered.",re["installation-not-found"]="Firebase Installation not found.",re["request-failed"]='{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',re["app-offline"]="Could not process request. Application offline.",re["delete-pending-registration"]="Can't delete installation while there is a pending registration request.",re),be=new se.a("installations","Installations",ge),me=/^[cdef][\w-]{21}$/,ye="",we=new Map,_e=null,ke="firebase-installations-database",Se=1,Ce="firebase-installations-store",Ae=null;!/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
***************************************************************************** */
function r(){for(var e=0,t=0,n=arguments.length;t<n;t++)e+=arguments[t].length;for(var r=Array(e),i=0,t=0;t<n;t++)for(var o=arguments[t],a=0,s=o.length;a<s;a++,i++)r[i]=o[a];return r}function i(e){c.forEach(function(t){t.setLogLevel(e)})}function o(e,t){for(var n=0,r=c;n<r.length;n++){var i=r[n];!function(n){var r=null;t&&t.level&&(r=u[t.level]),n.userLogHandler=null===e?null:function(t,n){for(var i=[],o=2;o<arguments.length;o++)i[o-2]=arguments[o];var a=i.map(function(e){if(null==e)return null;if("string"==typeof e)return e;if("number"==typeof e||"boolean"==typeof e)return e.toString();if(e instanceof Error)return e.message;try{return JSON.stringify(e)}catch(e){return null}}).filter(function(e){return e}).join(" ");n>=(null!==r&&void 0!==r?r:t.logLevel)&&e({level:s[n].toLowerCase(),message:a,args:i,type:t.name})}}(i)}}n.d(t,"a",function(){return h}),n.d(t,"b",function(){return i}),n.d(t,"c",function(){return o});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=4.e8e4d4d03179c1260a69.js.map